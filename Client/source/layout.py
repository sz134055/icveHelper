...
class main ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"ICVE-HELPER", pos = wx.DefaultPosition, size = wx.Size( 776,535 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
