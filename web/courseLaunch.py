        ...
        try:
            ...
            for course in all_my_course:
                ...
                for cell in all_course_cell:
                    ...
                    comment_info = my_course.all_comment(cell['id'], course['courseOpenId'],course['openClassId'], 1)
                    is_comment = False
                    for comment in comment_info:
                        if me.id == comment['user_id']:
                            ...
                            break
                    if not is_comment:
                        my_course.add_comment(cell['id'], course['courseOpenId'],course['openClassId'], user_info[16], user_info[15])
