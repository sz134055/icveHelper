...
def insert(
    ...
    try:
        cur.execute(
            "INSERT INTO user (userType, userId, userName, userPwd, newToken, displayName, employeeNumber, url, schoolName, schoolId,equipmentModel, equipmentApiVersion, clientId,email) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",
            (
                userType, userId, userName, userPwd, newToken, displayName, employeeNumber, url, schoolName, schoolId,
                equipmentModel, equipmentApiVersion, clientId,email))
